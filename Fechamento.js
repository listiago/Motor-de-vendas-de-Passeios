function enviarEmail() {
  ...
  planilha.getSheetByName("fechamento").hideSheet();
  ...
  planilha.getSheetByName("fechamento").activate();
    
    // Retorna uma Promise para sinalizar a conclusão da atualização
   return new Promise((resolve, reject) => {
  // Simule um atraso de 9 segundos (9000 milissegundos) para a atualização
